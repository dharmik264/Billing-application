              ...
              for (final row in items)
                pw.TableRow(
                  children: [
                    ...
                    _dataCell(row.rate.toStringAsFixed(2), align: pw.TextAlign.right),
                    _dataCell(row.subtotal.toStringAsFixed(2), align: pw.TextAlign.right),
                  ],
                ),
            ],
          ),
            ...
            children: [
              pw.TableRow(
                ...
                children: [
                  ...
                  _headerCell('Total Revenue (Rs.)', align: pw.TextAlign.right),
                ],
              ),
              for (final row in summary)
                pw.TableRow(
                  children: [
                    ...
                    _dataCell(row.totalRevenue.toStringAsFixed(2), align: pw.TextAlign.right),
                  ],
                ),
            ],
          ),
              ...
              for (final row in customers)
                pw.TableRow(
                  children: [
                    ...
                    _dataCell(row.billNumber),
                    _dataCell(row.amount.toStringAsFixed(2), align: pw.TextAlign.right),
            ...
            children: [
              pw.TableRow(
                ...
                children: [
                  ...
                  _headerCell('Total Spent (Rs.)', align: pw.TextAlign.right),
              ...
              for (final row in summary)
                pw.TableRow(
                  children: [
                    ...
                    _dataCell(row.totalSpent.toStringAsFixed(2), align: pw.TextAlign.right),
